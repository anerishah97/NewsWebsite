...
class Technology extends React.Component{
    ...
    {
        url = "https://nodejs-backend-273405.appspot.com/guardian-section?section=technology";
    }
    else
    {
        url = "https://nodejs-backend-273405.appspot.com/nyt-section?section=technology";
    }
    fetch(url)
